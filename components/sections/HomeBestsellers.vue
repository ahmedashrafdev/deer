<template>
  <section id="bestsellers" style="padding: 0 0 5rem 0">
    <div>
      <div class="container">
        <div
          v-lazyload
        ...
        >
          <section-header title="bestesellers">
            <div class="controllers">
              <div class="viewmore">
                <a class="btnrounded">{{ $t('view_more') }}</a>
              </div>
              <div class="next" @click.prevent="$refs.bestesellers.goToNext()">
                <a class="btncircle">
                  <svg
              ...
              <div class="prev" @click.prevent="$refs.bestesellers.goToPrev()">
                <a class="btncircle">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 511.949 511.949"
